      ...
      <div className="flex mt-20   justify-center ">
        <button
          className={`py-2 px-4 font-bold text-2xl ${
            activeTab === 1
              ? "text-black rounded-full bg-orange-400 bg-opacity-50 py-1 px-3"
              : "text-black"
          }`}
          onClick={() => changeTab(1)}
        >
              ...
              <tbody>
                {orders.map((item) => (
                  <tr key={item.id}>
                    ...
                    >
                      <p
                        className={`inline-flex rounded-full bg-opacity-50 py-1 px-3 text-sm font-medium text-slate-700 ${
        ...
        {activeTab === 2 && (
          <div className="">
            <table className="w-full table-auto">
              ...
              <tbody>
                {orders
                  .filter((item) => item.status === "chờ_xử_lý")
                  .map((item) => (
                    <tr key={item.id}>
                      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <p className="inline-flex rounded-full bg-red-300 bg-opacity-0 py-1 px-3 text-lg font-light text-black">
        ...
        {activeTab === 3 && (
          <div className="">
            <table className="w-full table-auto">
              ...
              <tbody>
                {orders
                  .filter((item) => item.status === "đã_xử_lý")
                  .map((item) => (
                    <tr key={item.id}>
                      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <p className="inline-flex rounded-full bg-red-300 bg-opacity-0 py-1 px-3 text-lg font-light text-black">
